                                ...
                                <React.Fragment>
                                    {
                                        rows.map((row, index) => 
                                                <div key={index}>
                                                    <div>
                                                        {row.button ? <Link to={{pathname: '/browse', state: {url: row.url}}} className="btn btn-outline-dark float-right"> <i className="fas fa-chevron-right"></i> Browse More </Link> : null}
